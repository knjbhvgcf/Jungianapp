...
export const BEEBE_ROLES: BeebeRole[] = [
  {
    key: 'hero',
    label: 'Hero / Heroine',
    full: 'Hero / Heroine (1st position)',
    ring: 'ego',
  ...
  },
  {
    key: 'child',
    label: 'Eternal Child',
    full: 'Eternal Child (3rd position)',
    ring: 'ego',
  ...
  },
  {
    key: 'anima',
    label: 'Inferior',
    full: 'Inferior (Anima / Animus) (4th position)',
    ring: 'ego',
  ...
  },
  {
    ...
    full: 'Opposing Nemesis (5th position)',
    ring: 'shadow',
